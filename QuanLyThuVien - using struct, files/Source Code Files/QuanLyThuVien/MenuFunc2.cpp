...
void Func2_Menu(char CurrentDate[11], int& ListSach, strSach Sach[100])
{
	...
	while (true)
	{
		...
		Func2_NhapChucNangMenu(Func, ListSach, Sach); //Thuc hien chuc nang
	}
}
...
{
	if (strcmp(Func, "a") == 0) { Func2a(ListSach, Sach); return; }
	if (strcmp(Func, "b") == 0) { Func2b(ListSach, Sach); return; }
	if (strcmp(Func, "c") == 0) { Func2c(ListSach, Sach); return; }
	if (strcmp(Func, "d") == 0) { Func2d(ListSach, Sach); return; }
	if (strcmp(Func, "e") == 0) { Func2e(ListSach, Sach); return; }
	if (strcmp(Func, "f") == 0) { Func2f(ListSach, Sach); return; }
}